...
export type Series = 'test:series' | '3070' | '3080' | '3090' | '6800xt';

export type Link = {
	brand: 'test:brand' | 'asus' | 'evga' | 'gainward' | 'gigabyte' | 'inno3d' | 'kfa2' | 'msi' | 'nvidia' | 'palit' | 'pny' | 'zotac' | 'xfx' | 'sapphire' | 'powercolor';
	series: Series;
	model: string;
	url: string;
	cartUrl?: string;
